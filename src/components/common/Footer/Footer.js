 ...
 * Footer
 *
 * This component renders the footer section with the club logo,
 * social media links, legal information and copyright notice.
 * Follows the design pattern similar to modern esports organizations.
 */
const Footer = () => {
  return (
    <footer className="fnatic-footer">
      <div className="footer-content">
        {/* Logo section */}
        <div className="footer-logo">
          <img src={FnaticLogo} alt="Fnatic de Temu Logo" />
        </div>
        ...
        <div className="footer-copyright">
          <p>©2025 Fnatic de Temu | All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
